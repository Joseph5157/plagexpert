...
const faqs = [
  ...
  { question: 'How do I submit my file?', answer: 'Message us on WhatsApp, select your plan, complete payment, and follow the upload instructions.' }
]
</script>
    ...
    <div class="mx-auto max-w-7xl">
      <div class="grid gap-8 lg:grid-cols-[0.8fr_1.2fr] lg:items-start lg:gap-10">
        <div>
          ...
          <NuxtLink
            to="/faq"
            class="mt-6 inline-flex w-full justify-center rounded-full border border-[#E2E8F0] bg-white px-6 py-3 text-sm font-semibold text-[#0F172A] shadow-sm transition hover:border-[var(--plagexpert-primary-blue)] hover:bg-[var(--plagexpert-soft-blue)] sm:w-auto"
          >
            View all FAQs
          </NuxtLink>
        </div>
