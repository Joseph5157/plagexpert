import { w as withLeadingSlash, j as joinRelativeURL, u as useRuntimeConfig, g as getResponseStatusText, c as getResponseStatus, e as defineRenderHandler, f as getQuery, h as createError, d as destr, i as getRouteRules, k as joinURL, b as useNitroApp } from '../_/nitro.mjs';
...
const appHead = {"meta":[{"name":"description","content":"Get accurate Turnitin and Drillbit plagiarism & AI detection reports for your thesis, dissertation, or assignment. Non-repository scans. Delivery in 10–30 minutes. Trusted by 50,000+ students in India."},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[],"style":[],"script":[],"noscript":[],"htmlAttrs":{"lang":"en"},"title":"PlagExpert — Turnitin & Drillbit Plagiarism & AI Reports for Students"};
