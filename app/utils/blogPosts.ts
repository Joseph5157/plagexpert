...
export const blogPosts: BlogPost[] = [
  {
    ...
    sections: [
      ...
      { type: 'list', items: [
        'Choose your plan — Single file (₹99) for one chapter, or Student Plan (₹1,149 for 15 files) for your full thesis and multiple drafts.',
      ...
      { type: 'paragraph', text: 'Our Student Plan (15 files for ₹1,149) is designed exactly for this workflow — covering multiple draft checks, chapter-level checks, and a final submission check, all at far lower cost than buying single checks each time.' },
