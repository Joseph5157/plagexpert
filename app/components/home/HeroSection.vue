  ...
  <section class="relative isolate overflow-hidden bg-[linear-gradient(180deg,#F8FAFC_0%,#FFFFFF_60%,#EFF6FF_100%)] px-4 pt-6 pb-6 sm:pt-8 sm:pb-8 lg:pt-10 lg:pb-8">
    ...
    <div class="relative mx-auto grid max-w-7xl items-start gap-10 lg:grid-cols-2 lg:gap-16">
      <div class="max-w-2xl">
        ...
        <p class="mt-5 max-w-xl text-base leading-7 text-[#334155] sm:mt-6 sm:text-lg sm:leading-8" data-speakable>
        ...
        <p class="mt-4 text-sm font-semibold text-[#0F766E]">
        ...
        <div class="mt-6 flex flex-col gap-3 sm:mt-8 sm:flex-row sm:gap-4">
          <a
            :href="getWhatsAppUrl()"
            class="inline-flex w-full items-center justify-center gap-2 rounded-full bg-[#15803D] px-6 py-3.5 text-center text-sm font-semibold text-white shadow-[0_18px_40px_rgba(22,163,74,0.24)] transition hover:bg-[#166534] sm:w-auto sm:px-8"
          >
