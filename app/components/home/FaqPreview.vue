...
<template>
  <section id="faq" class="bg-surface px-4 pt-4 pb-8 sm:pt-6 sm:pb-10 lg:pt-8 lg:pb-12">
    <div class="mx-auto max-w-7xl">
      <div class="grid gap-8 lg:grid-cols-[0.8fr_1.2fr] lg:items-center lg:gap-10">
        <div>
          ...
          <NuxtLink
            to="/faq"
            class="mt-6 flex w-full items-center justify-center rounded-full border border-line bg-white px-6 py-3 text-sm font-semibold text-ink shadow-sm transition hover:border-primary hover:bg-primary-50 sm:w-auto"
          >
            View all FAQs
          </NuxtLink>
        </div>
        ...
        <div class="space-y-3 md:hidden">
          ...
          >
            ...
            <p class="mt-4 text-base leading-7 text-body">{{ faq.answer }}</p>
          </details>
        </div>
