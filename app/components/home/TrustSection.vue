...
<template>
  <section class="bg-surface px-4 pt-4 pb-8 sm:pt-5 sm:pb-10 lg:pt-6 lg:pb-12">
    <div class="mx-auto max-w-7xl">
      ...
      <div class="mt-6 grid gap-4 sm:mt-8 sm:grid-cols-2 lg:grid-cols-4 sm:gap-6">
        <div
          ...
          :key="card.title"
          class="rounded-[2rem] border border-line bg-white p-6 shadow-[0_18px_50px_rgba(16,24,40,0.06)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_24px_60px_rgba(16,24,40,0.12)] sm:p-7"
        >
          <div class="flex h-11 w-11 items-center justify-center rounded-2xl bg-primary-50 text-2xl shadow-inner sm:h-12 sm:w-12">
            {{ card.icon }}
          </div>
